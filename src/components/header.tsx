...
export default function Header() {
  ...
  return (
    <main className="w-full">
      <div className="sticky z-20 w-full bg-white text-[#151531] text-[16px] font-bold mb-5">
        <div className="p-4 justify-between items-center relative hidden md:flex">
          <a href="/">
            <Image
              src="/navbar/june-logo-black.svg"
              alt="Logo"
              width={100}
              height={32}
            />
          ...
          <div className="flex">
            <div>
              ...
              >
                ...
                {showDropdownList && (
                  <div
                    className={`flex flex-col border-2 rounded-xl border-[#F8F9FA] absolute z-20 top-[50px] bg-white p-3 shadow-[0_1px_3px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.06)] ${
